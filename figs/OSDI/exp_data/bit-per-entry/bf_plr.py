...
plt.legend([OURS,BF], labels=["PLR","FP", "PLR-ORIG"], frameon=False,loc="upper center", bbox_to_anchor=(0.48, 1.23),ncol=3, handlelength=1, columnspacing=1, handletextpad=0.2,fontsize=20)
