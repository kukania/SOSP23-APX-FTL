...
output_path = "" # default: ""
output_name = "Filebench_throughput" 
#output_name = "TPCH"

'''
workload_num = 5
workname_list = ["RM-R", "RM-W", "RR", "RW", "SW"] #반드시 workname_list elem 개수와 workload num이 일치해야함. 
#workname_list = ["TPC-H"]
result_path = "FAST21-RESULT-throughput.xlsx" #분석위한 xlsx파일 path 입력
sheet_name = "some_fio" #분석할 sheet name 입력 
#sheet_name = "16_frag_tpch"
output_path = "" # default: ""
output_name = "fio_nosr_throughput" 
'''
...
plt.yticks([(i)*15000 for i in range(6)], fontsize=14)
plt.ylim([0,75000])
...
plt.legend((p1[0], p2[0], p3[0], p4[0], p5[0], p6[0]), ('PAGE','COARSE','FINE','SFTL','TPFTL','APPX'),framealpha=1, bbox_to_anchor=(0.69,1), fontsize=13, ncol=3, edgecolor='white')
